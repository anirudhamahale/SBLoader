...
class ArcLayer: CAShapeLayer {
    ...
    func animate() {
        ...
        arcHighAnimation.toValue = arcPathHight.CGPath
        ...
        arcCompleteAnimation.fromValue = arcPathHight.CGPath
        ...
        arcAnimationGroup.duration = arcCompleteAnimation.duration + animationDuration
